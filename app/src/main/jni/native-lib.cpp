...
Java_com_lyz_opencvsample_ImagesStitchUtil_stitchImages(JNIEnv *env, jclass type,
                                                        jobjectArray paths) {
...
//        cvtColor(mat, mat, CV_RGBA2RGB);
    ...
    LOGI("开始拼接......");
    Ptr<Stitcher> stitcher = cv::Stitcher::create();
...
Java_com_lyz_opencvsample_ImagesStitchUtil_getMat(JNIEnv *env, jclass type, jlong mat) {
...
Java_com_lyz_opencvsample_ImagesStitchUtil_getBitmap(JNIEnv *env, jclass type, jobject bitmap) {
